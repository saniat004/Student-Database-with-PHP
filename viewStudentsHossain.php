...
$sql = "SELECT * FROM  student_hossain_50045";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<br> id: ". $row["student_id_50045"]. " --Name : ". $row["Name_50045"]. " --Surname :  " . $row["SurName_50045"] . " --student number :  " . $row["studentID_50045"] . "<br>";
    }
} else {
    echo "0 results";
}
